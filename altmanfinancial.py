...
def compute_altman_z(ticker: str):
    """
    Retrieves data for the given ticker and calculates the Altman Z‑Score.
    ...
    Essential values come from:
      - Total Assets (using "Total Assets")
      - Total Liabilities (using "Total Liab", "Total Liabilities", or "Total Liabilities Net Minority Interest")
      - Market Value of Equity (calculated from the share price and shares outstanding)
...
def main():
    ...
    # Use a sidebar radio button to choose the analysis page.
    page = st.sidebar.radio("Select Analysis", ["Dividend Dashboard", "Altman Z‑Score"])
    ...
    if page == "Dividend Dashboard":
        ...
        **Altman Z‑Score Explanation:**
        ...
        The Altman Z‑Score is a financial model used to predict the likelihood of bankruptcy. It is calculated by combining five ratios derived from a company's financial statements:
